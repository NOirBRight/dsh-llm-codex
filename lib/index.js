...
function apply(ctx, config) {
	...
	ctx.inject(["connection"], (connectionCtx) => {
		connectionCtx.connection.rpc.handle(CODEX_RPC_CHANNEL, createCodexManagementRpcHandler(ctx, auth), { authority: config.remoteManagement === true ? "trusted-host" : "loopback" });
	});
	let stopped = false;
	let searchFiber;
