	...
	factory: (require) => {
		...
		async function readCodexUsage(rpc, signal) {
			...
			while (!signal.aborted) {
				...
				last = result.ok ? decodeCodexAuthStatus$1(result.value) : {
					status: "error",
		...
		*/
		...
		function CodexPluginCard(props) {
			...
			*/
			...
			const usageAnswered = auth.status === "signed-in" && (auth.usage !== void 0 || lastUsage !== void 0);
			const headerQuota = liveQuota ?? (auth.status === "signed-in" && !usageAnswered ? headerQuotaFromCache(peekCachedUsage(USAGE_PROVIDER_KEY)) ?? null : null);
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProviderCardHeader, {
							...
							role: "llm",
							...headerQuota === null ? auth.status === "signed-in" && refreshError !== void 0 ? { quota: { label: t("usage") } } : {} : { quota: headerQuota }
						})
					}),
