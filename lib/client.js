	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			pickerDescription: "Pick which Codex models appear in the conversation selector. Fast is a separate row.",
		...
		const zh = {
			...
			requestFailed: "请求失败。",
			pickerTitle: "选择模型",
			pickerDescription: "选择要在对话选择器里显示的 Codex 模型。Fast 是单独一行。",
