window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._1a80e2328969702f645564807cbb62c8/node_modules/dsh-llm-providers-ui/lib/usage-readers.js
		...
		*/
		...
		function decodeCodexAuthStatus$1(value) {
			...
			for (const rateLimitValue of usage.rateLimits) {
				...
				if (rateLimit === void 0 || !nonEmptyString$2(rateLimit.id) || !Array.isArray(rateLimit.windows)) return {
					status: "error",
					message: "malformed usage response"
				};
				if (rateLimit.name !== void 0 && !nonEmptyString$2(rateLimit.name)) return {
					status: "error",
					message: "malformed usage response"
				};
				for (const [index, windowValue] of rateLimit.windows.entries()) {
					...
					if (quotaWindow.resetsAt !== void 0 && !nonEmptyString$2(quotaWindow.resetsAt)) return {
						status: "error",
						message: "malformed usage response"
					};
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._1a80e2328969702f645564807cbb62c8/node_modules/dsh-llm-providers-ui/lib/provider-ui.js
		/** Plain-object guard shared by the reader factories and the sidebar cache validator. */
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._1a80e2328969702f645564807cbb62c8/node_modules/dsh-llm-providers-ui/lib/sortable.js
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/dsh-llm-providers-ui@file+..+..+..+..+.dsh-lab+tmp+dsh-llm-providers-ui-0.1.12-preview._1a80e2328969702f645564807cbb62c8/node_modules/dsh-llm-providers-ui/lib/provider-detail.js
		/** Non-empty string guard shared by the reader factories and the sidebar cache validator. */
