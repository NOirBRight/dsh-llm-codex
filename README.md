...
dsh plugin --profile web add --force \
  https://github.com/NOirBRight/dsh-llm-codex/releases/download/v0.3.19/dsh-llm-codex-0.3.19.tgz
dsh web
~~~
...
Rollback: rerun the fixed v0.3.19 command, verify the profile list, then restart the Web service once. Inspect journalctl --user -u dsh-web.service and dsh plugin --profile web doctor; never put a source checkout in the production profile.

Release and integrity: [v0.3.19](https://github.com/NOirBRight/dsh-llm-codex/releases/tag/v0.3.19) · [SHA256SUMS](https://github.com/NOirBRight/dsh-llm-codex/releases/download/v0.3.19/SHA256SUMS).
