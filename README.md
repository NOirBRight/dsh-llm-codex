...
DSH peer and development dependency ranges accept `0.1.7-alpha.2` and later releases. Cordis peers accept `>=4.0.4 <5.0.0`.
...
dsh plugin --profile web add --force \
  https://github.com/NOirBRight/dsh-llm-codex/releases/download/v0.3.25/dsh-llm-codex-0.3.25.tgz
dsh web
~~~
...
ChatGPT Codex login, model catalog, usage, and optional search/image capabilities. This release targets official DeepSeek Harness `0.1.7-rc.1` and contains built Host/Client files only; it has no sibling-repository source, workstation path, link:, or workspace: dependency.
...
dsh plugin --profile web add --force \
  https://github.com/NOirBRight/dsh-llm-codex/releases/latest/download/dsh-llm-codex-0.3.25.tgz
~~~
...
Release and integrity: [v0.3.25](https://github.com/NOirBRight/dsh-llm-codex/releases/tag/v0.3.25) · [SHA256SUMS](https://github.com/NOirBRight/dsh-llm-codex/releases/download/v0.3.25/SHA256SUMS).
